...
SRC = main.cpp application/menu.cpp application/menu_edit.cpp application/callbacks.cpp application/functions.cpp \
      ...
      audio/buffer.cpp audio/file_io.cpp audio/gui.cpp audio/clip.cpp view/waveform.cpp dialogs/dialog.cpp dialogs/new_file.cpp \
      dialogs/settings.cpp marking/marking.cpp marking/marker.cpp dialogs/renaming.cpp widgets/time.cpp
